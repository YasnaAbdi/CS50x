...
card4 = int(card4 % 100 / 10) + (card % 10)
card5 = int(card5 % 100 / 10) + (card4 % 10)
card6 = int(card6 % 100 / 10) + (card5 % 10)
card7 = int(card7 % 100 / 10) + (card6 % 10)
card8 = int(card8 % 100 / 10) + (card7 % 10)
